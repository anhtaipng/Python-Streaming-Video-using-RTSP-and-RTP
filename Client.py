...
#python3 ClientLauncher.py c45-Precision-M4600 3000 7000 movie.Mjpeg
...
class Client:
	...
	def __init__(self, master, serveraddr, serverport, rtpport, filename):
		...
		self.toltalPlayTime = 0 #Time in milliseconds of video playing since beginning
		self.fractionLost = 0 #Fraction of RTP data packets from sender lost since the prev packet was sent
		self.sumLost = 0 #Number of packets lost
		self.expRtpNum = 0 #Expected Sequence number of RTP messages within the session
